...
namespace Co2SensorController {
    ...
    enum SensorErrorCode : int {
        SUCCESS = 0, ///< Operation succeeded without any errors
        NOT_CONNECTED_ERROR = -1, ///< Sensor is not properly connected or not detected
        MEASUREMENT_NOT_VALID_ERROR = -2 ///< Measurement is outside the valid range
    };
